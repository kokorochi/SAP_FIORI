sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("test_01/test_01/app", ".html");
		...
		return Opa5.extend("test_01.test_01.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["test_01/test_01/localService/mockserver"], function (mockserver) {
